...
class Sample09MatrixRotateView : View {
    ...
    override fun draw(canvas: Canvas) {
        ...
        canvas.save()
        mMatrix.reset()
        mMatrix.postRotate(180f, (point1.x + bitmapWidth / 2).toFloat(), (point1.y + bitmapHeight / 2).toFloat())
        ...
        canvas.save()
        mMatrix.reset()
        mMatrix.postRotate(45f, (point2.x + bitmapWidth / 2).toFloat(), (point2.y + bitmapHeight / 2).toFloat())
        canvas.concat(mMatrix)

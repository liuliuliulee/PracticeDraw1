...
class Sample08MatrixScaleView : View {
    ...
    override fun draw(canvas: Canvas) {
        ...
        canvas.save()
        mMatrix.reset()
        mMatrix.postScale(1.3f, 1.3f, (point1.x + bitmapWidth / 2).toFloat(), (point1.y + bitmapHeight / 2).toFloat())
        ...
        canvas.save()
        mMatrix.reset()
        mMatrix.postScale(0.6f, 1.6f, (point2.x + bitmapWidth / 2).toFloat(), (point2.y + bitmapHeight / 2).toFloat())
        canvas.concat(mMatrix)
